...
## Часть 3
### Создание скрипта телеграм бота для решения задачи генерации текста или машинного перевода
#### Шаг 1
Для начала создадим папку будущего проекта и поместим туда все ранее полученные файлы: модель onnx и токенизатор/словарь для токенизации (в зависимости от решаемой задачи). В случае решения задачи машинного перевода моделей в формате onnx будет две.
#### Шаг 2
